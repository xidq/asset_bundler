...
pub fn ui_right_panel_settings_0(proxy_self: &mut Appencja,_ctx: &Context,ui: &mut egui::Ui, _fiolet_ciemny:Color32,_zolty_ciemny:Color32,_szarawy_ciemny:Color32){
    ...
    ui.vertical_centered_justified(|ui|{
        ui.checkbox(&mut proxy_self.ui_ustawienia_tworzenie_pliku_lua, RichText::new(proxy_self.current_language.create_lua_file.to_string()).font(wybrana_aktualna_czcionka(proxy_self.formatowanie_rozmiar_czcionki_srednia,proxy_self.formatowanie_wybor_czcionki)));
    });
