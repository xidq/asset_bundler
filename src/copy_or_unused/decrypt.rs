...
pub fn decrypt_files(dat_path: &Path, idx_path: &Path, output_folder: &str, de_password: &str, toggle_encryption: u8) -> std::result::Result<(usize, Duration), std::io::Error > {
    ...
    Ok((processed_files_count,czas_trwania))
}
